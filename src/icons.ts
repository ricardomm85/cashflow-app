...
export const icons = {
  ...
  sun: () => svg([c(12, 12, 4), p('M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41')]),
  moon: () => svg([p('M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79Z')]),
};
